...
<section id="home" class="relative overflow-hidden">
  <div class="absolute inset-0" style="z-index:0">
    <div id="heroMedia" class="absolute inset-0 w-full h-[120%]">
      <div class="hero-slide absolute inset-0 is-active" data-hero="video" data-hero-index="0">
        <video id="heroVideo" class="w-full h-full object-cover" muted loop playsinline preload="none" poster="/media/entrance-living-asia-poster-1280.webp">
          <source src="/entrance-living-asia-lite.webm" type="video/webm">
        </video>
        <img id="heroPoster" class="hero-poster absolute inset-0 w-full h-full object-cover" src="/media/entrance-living-asia-poster-768.webp" alt="" decoding="async" fetchpriority="high" width="1280" height="720">
      </div>
...
<section id="villa" class="relative h-[80vh] md:h-screen overflow-hidden">
  <div class="parallax-frame absolute inset-0 overflow-hidden">
    <div id="bleedImg" class="parallax-media fbleed-bg absolute w-full">
      ${mediaPicture({
        name: "jaipur",
        alt: "Jaipur residence exterior",
        imgClass: "w-full h-full object-cover",
        sizes: "100vw",
        loading: "lazy",
      })}
  ...
  <div class="absolute inset-0" style="z-index:1;background:linear-gradient(to top,rgba(15,30,22,.7),transparent 60%)"></div>
  <div class="absolute bottom-0 left-0 max-w-lg" style="z-index:2;padding:clamp(30px,5vw,64px)">
...
<section id="projects" class="bg-[#173426]" style="padding:clamp(70px,10vw,140px) clamp(20px,5vw,84px)">
  ...
  <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
    <a href="#reserve" class="pcard rv group relative overflow-hidden rounded-lg h-[380px] block">
      ${mediaPicture({ name: "living-asia-maldives-street", alt: "Living Asia residential neighborhood", imgClass: "w-full h-full object-cover object-[88%_center]", sizes: cardSizes, widths: [480, 768, 1280] })}
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      const setupParallax = (yPercent) => {
        ...
        make("#bleedImg", "#villa", -yPercent, yPercent);
